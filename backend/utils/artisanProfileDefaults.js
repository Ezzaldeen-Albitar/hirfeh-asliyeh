const DEFAULT_ARTISAN_AVATAR_IMAGE = 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=400&q=80';
...
export function getDefaultArtisanAvatarImage() {
  return DEFAULT_ARTISAN_AVATAR_IMAGE;
}
...
export { DEFAULT_ARTISAN_AVATAR_IMAGE, DEFAULT_ARTISAN_COVER_IMAGE };
