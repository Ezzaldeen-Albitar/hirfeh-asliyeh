...
function ArtisanDashboard() {
  ...
  const [editProduct, setEditProduct] = useState(null); // null = new, obj = edit
      ...
      <div className="container" style={{padding:'32px 12px 60px'}}>
                      ...
                      {products.map(p=>(
                        <tr key={p._id} style={{borderBottom:'1px solid var(--gold-pale)'}}>
                          <td className="px-3 py-2">
                            <div style={{width:48,height:48,borderRadius:"inherit",overflow:"hidden",position:"relative",flexShrink:0}}><Image src={p.images?.[0]||'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=60&q=60'} alt="" fill sizes="48px" style={{objectFit:"cover"}}/></div>
                          </td>
                          <td className="px-3">
        ...
        {tab===3 && (
          <div className="row g-4">
            ...
            <div className="col-md-8">
              {activeCustom
                ? <CustomizationChat messages={activeCustom.messages||[]} onSend={handleSendMessage}/>
