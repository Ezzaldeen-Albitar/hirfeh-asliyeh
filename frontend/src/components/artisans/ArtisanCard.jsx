  ...
  return (
    <div className="ha-card overflow-hidden h-100">
      ...
      <div className="p-3 pt-5">
        <h5 style={{fontFamily:'Amiri,serif',color:'var(--charcoal)',marginBottom:2}}>{artisan.name}</h5>
        ...
        <div className="d-flex gap-3 mb-3" style={{fontSize:'0.8rem',color:'var(--warm-gray)'}}>
          <span><i className="bi bi-box-seam me-1 text-gold"/>{artisan.productsCount || 0} منتج</span>
          <span><i className="bi bi-award me-1 text-gold"/>{artisan.yearsExp || 0} سنة خبرة</span>
        </div>
